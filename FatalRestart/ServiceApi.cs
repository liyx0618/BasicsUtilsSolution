...
{
    /// <summary>
    /// Service管理相关的win32api
    /// <seealso cref="http://blog.csdn.net/jiangxinyu/article/details/5404841"/>
    /// </summary>
    public class modAPI
    {
        ...
        [DllImport("advapi32.dll", CharSet = CharSet.Ansi, SetLastError = true, EntryPoint = "QueryServiceConfig2A")]
        ...
        public const Int32 SC_MANAGER_ALL_ACCESS = 0x000F003F;
        public const Int32 SERVICE_QUERY_CONFIG = 0x00000001;
        public const UInt32 SERVICE_CONFIG_DESCRIPTION = 0x01;
